...
|---|---|---|---|---|
| 显示器列表 | 分辨率/刷新率/主副屏/DDC 能力/当前色彩配置 | ✅ | 🟡（无分辨率） | 🟡（部分） |
| 亮度/音量 DDC | 滑块实时控制（需硬件支持 DDC/CI） | ✅ | ✅ | ✅ |
| 色彩同步 | 一键把全部屏对齐 sRGB / Display P3 / Adobe RGB | ✅ | ⏳ | ⏳ |
| 对齐 Mac | 外接屏对齐 Mac 内建屏（Display P3） | ✅ | ⏳ | ⏳ |
| 窗口跨屏等大 | 副屏对齐 2x 逻辑档，窗口拖动不变小（**不会**降 4K 物理分辨率） | ✅ | ⏳ | ⏳ |
| 副屏横竖切换 | 一键旋转/恢复（按真实布局动态计算，无硬编码） | ✅ | ⏳ | ⏳ |
| 双屏铺满 | VLC 窗口铺满所有屏的真实包围盒，跨屏看电影 | ✅ | ⏳ | ⏳ |
